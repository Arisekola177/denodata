...
const TopNav = () => {
  return (
    <div className="hidden md:block bg-very-dark-violet text-white py-4 sticky top-0 z-50">
          <div className="lg:w-10/12 md:w-11/12 mx-auto flex items-center justify-between">
               ...
               <div className="flex items-center gap-4">
                <div className="flex items-center gap-1">
                  <FaClock  className='md:text-xs lg:text-base' />
                  <p className='md:text-xs lg:text-base'>9:00AM - 5:00PM</p>
                </div>
                <div>
                   |
                </div>
